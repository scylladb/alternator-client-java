...
public class AlternatorLiveNodesDnsDiscoveryTest {
  ...
  /** Verifies an A-only DNS entrypoint. */
  @Test(timeout = 10000)
  public void testIpv4OnlyDnsEntrypoint() throws Exception {
    InetAddress ipv4 = InetAddress.getByName("127.0.0.1");

    assertDnsDiscovery(ipv4, ipv4);
  }

  /** Verifies an AAAA-only DNS entrypoint. */
  @Test(timeout = 10000)
  public void testIpv6OnlyDnsEntrypoint() throws Exception {
    assumeIpv6LoopbackAvailable();
  ...
  /** Verifies failed-AAAA-to-A fallback. */
  @Test(timeout = 10000)
  ...
  /** Verifies failed-A-to-AAAA fallback. */
  @Test(timeout = 10000)
