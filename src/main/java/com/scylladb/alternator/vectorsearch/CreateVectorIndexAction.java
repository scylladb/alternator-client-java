...
public final class CreateVectorIndexAction {
  ...
  /**
   * Returns the projection, or {@code null} for the server default ({@code KEYS_ONLY}).
   *
  ...
  public static final class Builder {
    ...
    /**
     * Sets the projection. Alternator vector indexes currently support only {@code KEYS_ONLY}; if
     * omitted, the server uses that default.
     */
