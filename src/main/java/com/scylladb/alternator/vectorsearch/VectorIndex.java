...
public final class VectorIndex {
  ...
  /**
   * Returns the projection for this index, or {@code null} if using the server default ({@code
   * KEYS_ONLY}).
   *
   * <p>Alternator vector indexes currently support only {@code KEYS_ONLY} projections.
   */
  ...
  public static final class Builder {
    ...
    /**
     * Sets the projection for this index. Alternator vector indexes currently support only {@code
     * KEYS_ONLY}; if omitted, the server uses that default.
     */
